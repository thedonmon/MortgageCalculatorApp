...
<script lang="ts">
    ...
    export default class App extends Vue {
        ...
        private title: string = 'Mortgage & Property Investment Calculator';
        private items = [
            ...
            { title: 'Contact', icon: 'home', link: '/contact' },
            { title: 'Mortgage', icon: 'home', link: '/mortgage' },
